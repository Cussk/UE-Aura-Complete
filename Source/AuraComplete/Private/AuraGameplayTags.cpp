...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(TAG_Attributes_Primary_Intelligence, "Attributes.Primary.Intelligence", "Increases magical damage and mana");
...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(TAG_Attributes_Secondary_MaxHealth, "Attributes.Secondary.MaxHealth", "Total health character has");
UE_DEFINE_GAMEPLAY_TAG_COMMENT(TAG_Attributes_Secondary_MaxMana, "Attributes.Secondary.MaxMana", "Total mana character has");
...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(TAG_Attributes_Vitals_Mana, "Attributes.Vitals.Mana", "Used for casting spells and abilities");
